...
function request(method: string, path: string, data?: any, config?: any) {
  if (method === "GET") {
    let params: any = "";
    if (data) {
...
// get请求方法使用封装
function get(path: string, data?: any, config?: any) {
...
// put请求方法使用封装
function put(path: string, data: any, config?: any) {
  return request("PUT", path, data, config);
}

// delete请求方法使用封装
function del(path: string, data: any, config?: any) {
